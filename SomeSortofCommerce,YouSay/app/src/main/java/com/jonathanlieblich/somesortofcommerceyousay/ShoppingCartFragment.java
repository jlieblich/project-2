...
//Display current contents of shopping cart. Get contents from savedInstanceBundle
//OPTIONAL: during onStop(), save a reference ID to cart contents before exiting vis SharedPreferences
